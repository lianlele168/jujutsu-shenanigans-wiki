    ...
    <div className="space-y-8">
      <section className="bg-gradient-to-r from-slate-900 to-cyan-950 border border-cyan-800/40 rounded-2xl p-8 text-center space-y-4">
        <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight">
          Jujutsu Shenanigans Wiki (August 2026)
        </h1>
        <p className="text-slate-300 max-w-2xl mx-auto text-sm md:text-base">
          Comprehensive Jujutsu Shenanigans guide — Character PvP Tier List, Combo Builder, Awakening Guide, and Active Codes.
        </p>
