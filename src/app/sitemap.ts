...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://jujutsushenanigans.robloxwikihub.com';
  ...
  return [
    ...
    { url: `${baseUrl}/combo-calculator/`, lastModified: d, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/awakening-guide/`, lastModified: d, changeFrequency: 'weekly', priority: 0.8 },
